...
(1, '/images/webp/cooking-class-hero.webp', 'HERO', 'Authentic Hoi An cooking class with local family'),
(1, '/images/webp/cooking-class-group.webp', 'CAROUSEL', 'Cooking class participants preparing traditional dishes'),
(1, '/images/webp/fresh-ingredients.webp', 'CAROUSEL', 'Fresh local ingredients from Hoi An market'),
(1, '/images/webp/shrimp-salad.webp', 'CAROUSEL', 'Delicious traditional Vietnamese shrimp salad'),
(1, '/images/webp/finished-dish.webp', 'CAROUSEL', 'Beautifully presented finished Vietnamese dish'),
(1, '/images/webp/caramelized-fish.webp', 'CONTENT', 'Traditional stylized caramelized fish in clay pot'),
(1, '/images/webp/banana-flower-salad.webp', 'CONTENT', 'Fresh banana flower salad with local herbs'),
(2, '/images/webp/food-tour-hoi-an-13.webp', 'HERO', 'Hoi An food tour guide in ancient town'),
(2, '/images/webp/food-tour-hoi-an-6.webp', 'CAROUSEL', 'Food tour group enjoying local specialties'),
(2, '/images/webp/food-tour-hoi-an-4.webp', 'CAROUSEL', 'Grilled Nem spring rolls on charcoal'),
(2, '/images/webp/food-tour-hoi-an-8.webp', 'CAROUSEL', 'Street food stall in Hoi An ancient town'),
(2, '/images/webp/food-tour-hoi-an-1.webp', 'CONTENT', 'Authentic Hoi An Banh My baguette'),
(3, '/images/webp/lantern-class-hero.webp', 'HERO', 'Traditional Hoi An lantern making workshop'),
(3, '/images/webp/lantern-class-main.webp', 'CAROUSEL', 'Learning to craft silk lanterns with artisans'),
(3, '/images/webp/stock-lantern-1.webp', 'CAROUSEL', 'Colorful silk lanterns glowing at night'),
(3, '/images/webp/stock-lantern-2.webp', 'CAROUSEL', 'Bamboo frames for lantern making'),
(3, '/images/webp/stock-lantern-8.webp', 'CONTENT', 'Intricate details of a completed silk lantern'),
(4, '/images/webp/coffee-class-hero.webp', 'HERO', 'Vietnamese coffee making class in Hoi An'),
(4, '/images/webp/coffee-class-main.webp', 'CAROUSEL', 'Mastering the art of Vietnamese coffee brewing'),
(4, '/images/webp/stock-coffee-1.webp', 'CAROUSEL', 'Authentic Phin filter brewing coffee'),
(4, '/images/webp/stock-coffee-2.webp', 'CAROUSEL', 'Fluffy whipped egg yolks for egg coffee'),
(4, '/images/webp/stock-coffee-9.webp', 'CONTENT', 'Student preparing Vietnamese coffee');
